...
* The original package name 'com.sprintboot.jpa-and-hibernate' is invalid and this project uses 'com.sprintboot.jpaandhibernate' instead.
...
* [Spring Data JDBC](https://docs.spring.io/spring-boot/docs/3.3.0-M3/reference/htmlsingle/index.html#data.sql.jdbc)
