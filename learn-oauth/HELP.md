...
* The original package name 'com.spring.learn-oauth' is invalid and this project uses 'com.spring.learnoauth' instead.
...
* [OAuth2 Client](https://docs.spring.io/spring-boot/docs/3.3.0-M3/reference/htmlsingle/index.html#web.security.oauth2.client)
